...
### Fork Goals
 ...
 - Fast responses on issues and pull requests
 - Modern, maintainable code
 - Test coverage
 - Great documentation
 - Frequent releases on npm and bower
...
```html
<script src="pikaday2.js"></script>
<script>
    var picker = new Pikaday2({ field: document.getElementById('datepicker') });
</script>
```
...
```javascript
var picker = new Pikaday2({ field: $('#datepicker')[0] });
```
...
$('.datepicker').pikaday2({ firstDay: 1 });

// chain a few methods for the first datepicker, jQuery style!
$('.datepicker').eq(0).pikaday2('show').pikaday2('gotoYear', 2042);
...
```javascript
require(['pikaday2'], function(Pikaday2) {
    var picker = new Pikaday2({ field: document.getElementById('datepicker') });
});
```
...
```javascript
require(['jquery', 'pikaday2.jquery'], function($) {
    $('#datepicker').pikaday2();
});
```
...
* Nathan Cahill [Github][Cahill] [@nathancahill][Cahill Twitter]

Thanks to [@shoogledesigns][shoogledesigns] for the name.

* Copyright © 2014 David Bushell | BSD & MIT license
* Copyright © 2015 Nathan Cahill | BSD & MIT license

  [Pikaday2]:     http://nathancahill.github.com/Pikaday2/                         "Pikaday2"
  [moment]:      http://momentjs.com/                                             "moment.js"
  [browserify]:  http://browserify.org/                                           "browserify"
  [screenshot]:  https://raw.github.com/dbushell/Pikaday/gh-pages/screenshot.png  "Screenshot"
  [issues]:      https://github.com/nathancahill/Pikaday2/issues                  "Issue tracker"
  ...
  [Cahill]:      https://github.com/nathancahill                                  "Cahill Github"
  [Cahill Twitter]: https://twitter.com/nathancahill                              "@nathancahill"
  ...
  [moment.js example]: http://nathancahill.github.com/Pikaday2/examples/moment.html    "Pikaday w/ moment.js"
  [jQuery example]: http://nathancahill.github.com/Pikaday2/examples/jquery.html       "Pikaday w/ jQuery"
  [AMD example]: http://nathancahill.github.com/Pikaday2/examples/amd.html             "Pikaday w/ AMD"
  [jQuery AMD example]: http://nathancahill.github.com/Pikaday2/examples/jquery-amd.html "Pikaday w/ jQuery + AMD"
  [trigger example]: http://nathancahill.github.com/Pikaday2/examples/trigger.html     "Pikaday using custom trigger"
  [positions example]: http://nathancahill.github.com/Pikaday2/examples/positions.html "Pikaday using different position options"
  [container example]: http://nathancahill.github.com/Pikaday2/examples/container.html "Pikaday using custom calendar container"
  [theme example]: http://nathancahill.github.com/Pikaday2/examples/theme.html         "Pikaday using multiple themes"
